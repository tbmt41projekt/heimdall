    ...
    mclOutputHandlerFcn print_handler)
{
    ...
    if (!mclmcrInitialize())
        return false;
    if (!GetModuleFileName(GetModuleHandle("heimdall"), path_to_dll, _MAX_PATH))
        return false;
    {
...
{
    return heimdallInitializeWithHandlers(mclDefaultErrorHandler, mclDefaultPrintHandler);
}
